...
#    https://colab.research.google.com/drive/1GSfMTrGtuem_Q9sb1hwolXPXbXRhpUbW
#"""
...
plt.plot(date_range, model_predictions[:-1], color='blue', marker='o', linestyle='dashed', label ='BTC predicted value')
...
#3.8% MAPE implies model is about 96.2% accurate in predicting the test set obser